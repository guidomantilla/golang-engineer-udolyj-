...
const (
	...
	Api_Health_FullMethodName                = "/api.Api/Health"
	Api_Info_FullMethodName                  = "/api.Api/Info"
	Api_CreateAccount_FullMethodName         = "/api.Api/CreateAccount"
	Api_Transfer_FullMethodName              = "/api.Api/Transfer"
	Api_GetAccount_FullMethodName            = "/api.Api/GetAccount"
	Api_GetAccountWithEntries_FullMethodName = "/api.Api/GetAccountWithEntries"
)
